...
do
    ...
    local hitboxheadsizex, hitboxheadsizey, hitboxheadtransparency, cancollide = 30, 30, 0.5, false
    ...
    hbb:AddSlider('hitbox_head_size_x', { Text = 'size x', Default = 30, Min = 1, Max = 50, Rounding = 1, Compact = false }):OnChanged(function(State)
        hitboxheadsizex = State
        hbsize = _Vector3new(hitboxheadsizex, hitboxheadsizey, hitboxheadsizex)
    end)
    hbb:AddSlider('hitbox_head_size_y', { Text = 'size y', Default = 30, Min = 1, Max = 50, Rounding = 1, Compact = false }):OnChanged(function(State)
